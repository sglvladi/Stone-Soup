"""
multi-sonar-mfa-fuse-direct.py
...
- The data association algorithm used for both the local and fuse trackers is MFA.
"""
...
from stonesoup.initiator.twostate import TwoStateInitiator, FuseTrackerInitiator, \
    TwoStateMeasurementInitiator, TwoStateMeasurementInitiatorMixture
