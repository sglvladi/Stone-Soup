...
class PDA(DataAssociator):
    ...
    This is a correctly implemented PDA. Essentially, this data associator
    simply forwards the hypotheses generated by the provided hypothesiser.

    """
    hypothesiser = Property(
        Hypothesiser,
        doc="Expects a PDAHypothesiser")
