...
from stonesoup.models.transition.linear import OrnsteinUhlenbeck, CombinedLinearGaussianTransitionModel
from stonesoup.initiator.simple import SimpleMeasurementInitiator
from stonesoup.initiator.wrapper import StatesLengthLimiter
from stonesoup.deleter.time import UpdateTimeDeleter
from stonesoup.dataassociator.neighbour import GNNWith2DAssignment
from stonesoup.hypothesiser.distance import DistanceHypothesiserFast
...
# Detection readers
# ================
file_path = r'C:\Users\sglvladi\Documents\TrackAnalytics\data\exact_earth\id_sorted\exactEarth_historical_data_2017-08-10_id.csv'
...
detector = TimeSyncFeeder(detector, time_window=timedelta(seconds=1))
...
for scan_time, detections in detector.detections_gen():
    ...
    # Remove detections that are not within the selected region
