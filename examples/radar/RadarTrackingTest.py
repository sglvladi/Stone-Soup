...
def plot_platforms(platforms, radar_positions, radar_orientations, timestamp):
    for i, platform in enumerate(platforms):
        ...
        orientation = [orientation.state_vector
                       ...
                       if orientation.timestamp == timestamp][0]
        fov = radar.fov_angle
...
NUM_PLATFORMS = 1  # Number of platforms to simulate
...
noise_covar = CovarianceMatrix(np.array([[0.000001, 0],
                                         [0, 0.0001]]))
...
platform_transition_model = ConstantTurn([0.001, 0.001], 1)
...
for i in range(NUM_SIM_STEPS):
    ...
    for j, platform in enumerate(platforms):
        ...
        # Store position and orientation of platform/sensor(s)
...
updater = UnscentedKalmanUpdater(measurement_model=radar.measurement_model)
...
for i, detection in enumerate(detections):
    ...
    if detection is not None:
        ...
        hypothesis = SingleHypothesis(state_prediction, detection)
    ...
    plot_data(timestamp, groundtruth_paths, detections, [track],
