...
# videoReader = FFmpegVideoStreamReader('rtsp://192.168.0.10:554/1/h264major',
#                                       input_args=[[],{'threads':1, 'fflags':'nobuffer', 'vsync':0}],
#                                       output_args=[[],{'format':'rawvideo', 'pix_fmt':'rgb24'}])

# Infinite while loop to treat stack of image as video
old_frame = None
for timestamp, frame in videoReader.frame_gen():
    if not frame:
        continue
    ...
    for contour in cnts:
        ...
        cv2.rectangle(frame.pixels, (x, y), (x + w, y + h), (0, 255, 0), 3)
    ...
    cv2.imshow("Color Frame", frame.pixels)
