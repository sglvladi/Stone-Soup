...
for i in range(NUM_SIM_STEPS):
    ...
    for j, platform in enumerate(platforms):
        ...
        measurement_sonar.append(
            platform.sensors[0].gen_measurement(target_state))
...
for i, measurement in enumerate(measurement_sonar):
    ...
    plot_data(timestamp, groundtruth_paths, measurement_sonar, [track],
...
ospa = OSPAMetric(c=8, p=2, measurement_model_truth=sonar.measurement_model,
                  measurement_model_track=sonar.measurement_model)
